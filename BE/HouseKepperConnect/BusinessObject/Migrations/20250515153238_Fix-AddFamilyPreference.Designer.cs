...
namespace BusinessObject.Migrations
{
    ...
    [Migration("20250515153238_Fix-AddFamilyPreference")]
    partial class FixAddFamilyPreference
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObject.Models.FamilyPreference", b =>
                {
                    b.Property<int>("FamilyPreferenceID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FamilyPreferenceID"));
                    ...
                    b.HasKey("FamilyPreferenceID");

                    b.HasIndex("FamilyID");

                    b.ToTable("FamilyPreference");
                });

            modelBuilder.Entity("BusinessObject.Models.FamilyPreferenceSkill", b =>
                {
                    b.Property<int>("FamilyPreferenceSkillID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FamilyPreferenceSkillID"));
            ...
            modelBuilder.Entity("BusinessObject.Models.FamilyPreferenceSkill", b =>
                {
                    b.HasOne("BusinessObject.Models.FamilyPreference", "FamilyPreference")
                        .WithMany()
                        .HasForeignKey("FamilyPreferenceID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
