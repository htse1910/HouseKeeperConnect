...
public class WalletHousekeeperActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        APIServices api = APIClient.getClient(WalletHousekeeperActivity.this).create(APIServices.class);
        ...
        call.enqueue(new Callback<Wallet>() {
            ...
            public void onResponse(Call<Wallet> call, Response<Wallet> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(WalletHousekeeperActivity.this, "Ví không tồn tại", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<Wallet> call, Throwable t) {
                Toast.makeText(WalletHousekeeperActivity.this, "Lỗi: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        transactionCall.enqueue(new Callback<List<Transaction>>() {
            ...
            public void onResponse(Call<List<Transaction>> call, Response<List<Transaction>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(WalletHousekeeperActivity.this, "Không thể tải giao dịch", Toast.LENGTH_SHORT).show();
                }
            }
